...
| 事实 | 权威来源 | 必须同步的证据 |
| --- | --- | --- |
| v0.2 extensibility refactor boundary | `docs/v02-refactor-audit-and-plan.md`、`docs/v02-r0-status.md`、`docs/v02-r1-status.md` | R0/R1 architecture tests、Extension fixtures、每阶段状态文档和迁移 PR evidence |
