...
Phase 4 已按 ADR-0015 完成 Action 生命周期首片实现并进入合并收口；Outbox、Router/Policy、
Semantic Pulse、跨组件 Erasure 和 Backup 仍需独立闸门，详见 [Phase 4 Action 状态](phase4-action-status.md)。
